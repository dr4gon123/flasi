...
![create_policy](../../assets/installation/ingest/create_policy.png)

3. Add Integration
![add_integration](../../assets/installation/ingest/add_integration.png)

4. Select Custom UDP Logs
![custom_udp_logs](../../assets/installation/ingest/custom_udp_logs.png)

5. Configure Custom UDP Logs integration
![integration_parameters](../../assets/installation/ingest/integration_parameters.png)
