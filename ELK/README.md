...
Generates the `fortigate_{type}_{version}.json` component templates by fetching field definition CSVs from the [flores](https://github.com/dr4gon123/flores) GitHub repository.
...
| `FLORES_REPO` | `dr4gon123/flores` | GitHub repo to fetch CSVs from |
